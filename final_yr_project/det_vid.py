...
def run(
    ...
    names = {0:'bike', 2:'numberplate', 3:'helmet'}
                ...
                if number:
                    ...
                    if not row.empty:
                        ...
                        if today > end:
                            ...
                            bot.sendMessage('950794660', str('emission test validity expired of {}'.format(number)))
                        else:
                    ...
                    today=datetime.now()
                    if HV != '':
                        bot.sendMessage('950794660', str(HV+' violation with '+number+'at {}'.format(today)))
                        HV = ''
